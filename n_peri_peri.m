...
% Compute the Moon's position relative to the Earth at each coarse time step
...
for i = 1:length(min_indices)
    ...
    refined_perigee_times(end+1) = fine_times(fine_min_index); %#ok<AGROW>
end
